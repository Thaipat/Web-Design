...
const signinUsernameFeedback = `<img style="scale: 0.8; max-height: 2rem" src="warning.png">
<span class="feedback-text-color">Couldn't find your username</span>`

const signinPasswordFeedback = `<img style="scale: 0.8; max-height: 2rem" src="warning.png">
<span class="feedback-text-color">Password is incorrect</span>`

const signupUsernameFeedback = `<img style="scale: 0.8; max-height: 2rem" src="warning.png">
<span class="feedback-text-color">Username is already use</span>`

const signupPasswordFeedback = `<img style="scale: 0.8; max-height: 2rem" src="warning.png">
    ...
    accountRef.once("value").then((snapshot) => {
        snapshot.forEach((data) => {
            ...
            if (currentUsername == "") {
                ...
                document.querySelector("#signup-username-feedback").innerHTML = `<img style="scale: 0.8; max-height: 2rem" src="warning.png">
        ...
        if (usernameValid) {
            ...
            if (currentPassword == "") {
                document.querySelector("#register_Cpassword").value = ""
                document.querySelector("#confirmpassword-feedback").innerHTML = `<img style="scale: 0.8; max-height: 2rem" src="warning.png">
